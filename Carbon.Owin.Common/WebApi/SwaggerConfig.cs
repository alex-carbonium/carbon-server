...
namespace Carbon.Owin.Common.WebApi
{
    ...
    {
        private readonly Assembly _filterAssembly;

        public RouteOperationIdFilter(Assembly filterAssembly)
        {
            _filterAssembly = filterAssembly;
        }

        public void Apply(Operation operation, SchemaRegistry schemaRegistry, ApiDescription apiDescription)
        {
            if (apiDescription.ActionDescriptor.ControllerDescriptor.ControllerType.Assembly != _filterAssembly)
            {
                //mark for deletion
    ...
    internal class DocumentFilter : IDocumentFilter
    {
        public void Apply(SwaggerDocument swaggerDoc, SchemaRegistry schemaRegistry, IApiExplorer apiExplorer)
        {
            ...
            {
                if (path.Value.get != null && path.Value.get.deprecated
                    || path.Value.post != null && path.Value.post.deprecated)
                {
